...
function Loans({ addNotification, userProfile, userRole, companyId, showToast, showConfirm }) {
  ...
  <div className="rounded-xl shadow-sm border border-neutral-200 bg-white px-3 py-2 text-center flex-1"><div className="text-lg font-display font-bold text-neutral-800">{activeLoans.length}</div><div className="text-xs text-neutral-400">Active Loans</div></div>
