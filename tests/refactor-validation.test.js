...
function testFileStructure() {
  ...
  // 43000 on 2026-09-12, covering two separate pieces of work that each
  // needed room and would otherwise have stacked two raises:
  //   * src/utils/routes.js -- the routing vocabulary for real paths: 45
  //     page slugs and 31 report slugs. A whole-app router cannot fit in
  //     the 30 lines of headroom that were left.
  //   * findCountySchedule in utils/helpers.js, which
